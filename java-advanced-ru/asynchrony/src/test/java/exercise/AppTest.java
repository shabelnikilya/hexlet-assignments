...
class AppTest {
    ...
    // BEGIN
    @Test
    void testDirectorySize() throws ExecutionException, InterruptedException {
        String directory = "src/test/resources/dir";
        assertThat(getDirectorySize(directory).get()).isEqualTo(26L);
    }
    // END
}
